...
export function DoctorTalk(props: JSX.IntrinsicElements['group']) {
    const group = useRef<Group | null>(null);
    const { scene, animations } = useGLTF('/models/doctor_talk.glb');
...
useGLTF.preload('/models/doctor_talk.glb');
